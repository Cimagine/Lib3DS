...
typedef enum Lib3dsIoDecryptAction{
  LIB3DS_DECRYPT_INIT = 0,
  LIB3DS_DECRYPT_APPLY = 1,
  LIB3DS_DECRYPT_RESET = 2,
  LIB3DS_DECRYPT_CLEAR = 3
}Lib3dsIoDecryptAction;
...
typedef void (*Lib3dsIoDecryptFunc)(void *self, const void* chunk, Lib3dsIoDecryptAction action);
...
extern LIB3DSAPI Lib3dsIo* lib3ds_io_new(void *self, Lib3dsIoErrorFunc error_func,
  ...
  Lib3dsIoDecryptFunc decrypt_func);
...
extern LIB3DSAPI void lib3ds_io_decrypt(Lib3dsIo *io, const void *chunk, Lib3dsIoDecryptAction action);
