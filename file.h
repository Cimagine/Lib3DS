...
struct Lib3dsFile {
    ...
    Lib3dsLight *lights;
    Lib3dsNode *nodes;
    Lib3dsWord meshCount;
    Lib3dsWord materialCount;
}; 

extern LIB3DSAPI Lib3dsFile* lib3ds_file_load(const char *filename, Lib3dsIoDecryptFunc decrypt_func);
...
extern LIB3DSAPI void lib3ds_file_bounding_box_of_objects(Lib3dsFile *file, Lib3dsBool include_meshes, Lib3dsBool include_cameras, Lib3dsBool include_lights, Lib3dsBool include_shadows, Lib3dsVector bmin, Lib3dsVector bmax);
extern LIB3DSAPI void lib3ds_file_bounding_box_of_nodes(Lib3dsFile *file, Lib3dsBool include_meshes, Lib3dsBool include_cameras, Lib3dsBool include_lights, Lib3dsBool include_shadows, Lib3dsVector bmin, Lib3dsVector bmax);
